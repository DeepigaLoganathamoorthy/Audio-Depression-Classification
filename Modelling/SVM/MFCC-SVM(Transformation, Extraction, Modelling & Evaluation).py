...
S_mfcc_dev = np.array(S_mfcc_dev)
S_mfcc_dev_normalized = np.log(tf.abs(S_mfcc_dev) + 0.01)
S_mfcc_dev_normalized.shape

S_mfcc_train = np.array(S_mfcc_train)
S_mfcc_train_normalized = np.log(tf.abs(S_mfcc_train) + 0.01)
S_mfcc_train_normalized.shape

S_mfcc_dev_normalized = S_mfcc_dev_normalized.reshape(file_count_dev, -1)
S_mfcc_train_normalized = S_mfcc_train_normalized.reshape(file_count_train, -1)
...
phq8_array_train_extended = np.ndarray(shape = (780,))
phq8_array_dev_extended = np.ndarray(shape = (240,))
...
from sklearn.svm import SVC
clf = SVC(C=1.3, kernel='rbf')
clf.fit(S_mfcc_train_normalized, phq8_array_train_extended.ravel())
train_accuracy = clf.score(S_mfcc_train_normalized, phq8_array_train_extended.ravel())
print("Train accuracy: ", train_accuracy)
test_accuracy = clf.score(S_mfcc_dev_normalized, phq8_array_dev_extended.ravel())
print("Test accuracy: ", test_accuracy)
predictions = clf.decision_function(S_mfcc_dev_normalized)
...
y_pred = clf.predict(S_mfcc_dev_normalized)
...
y_pred_proba = clf.decision_function(S_mfcc_dev_normalized)
