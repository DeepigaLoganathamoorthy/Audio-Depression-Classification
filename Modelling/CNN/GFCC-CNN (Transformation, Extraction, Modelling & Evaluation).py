...
S_gfcc_train_normalized_array = np.ndarray(shape = (780,95,ancho))
S_gfcc_dev_normalized_array = np.ndarray(shape = (240,95,ancho))

i = 0
for train in S_gfcc_train_normalized:
    S_gfcc_train_normalized_array[i] = train[0:95,:]
    i += 1



i = 0
for train in S_gfcc_dev_normalized:
    S_gfcc_dev_normalized_array[i] = train[0:95,:]
    i += 1


S_gfcc_train_normalized_array = S_gfcc_train_normalized_array.reshape(780,95,ancho,1)
S_gfcc_dev_normalized_array = S_gfcc_dev_normalized_array.reshape(240,95,ancho,1)
...
S_gfcc_dev_normalized_array.shape #4D array
...
y_pred_scores = model.predict(S_gfcc_dev_normalized_array)[:,0]
